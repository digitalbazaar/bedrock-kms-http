...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      const schema = postKeystoreBody();
      const result = validation.validateInstance(req.body, schema);
  ...
  app.get(
    ...
    createMiddleware({strategy: 'session'}),
    asyncHandler(async (req, res) => {
      const schema = getKeystoreQuery();
      const result = validation.validateInstance(req.query, schema);
  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      const schema = zcap();
      const result = validation.validateInstance(req.bpdy, schema);
