...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  // WebKMS paths are fixed off of the base path
  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      // FIXME: remove once zcap authz is implemented for keystore creation
  ...
  // FIXME: determine if `authorization` will be removed; if preserved, update
  // to use ezcap-express
  /*
